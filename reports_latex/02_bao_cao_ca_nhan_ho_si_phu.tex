...
Chỉ các giá trị trong miền 40--180 BPM được đưa vào bộ làm mượt. Khoảng RR hợp lệ đầu tiên được hiển thị ngay, không chờ thêm nhiều nhịp; các nhịp kế tiếp chỉ được dùng nếu không lệch quá 22 BPM so với giá trị đang có. Với tín hiệu tổng hợp 75 BPM, kết quả đầu tiên xuất hiện không quá 1,75 giây. Thời gian thực tế vẫn phụ thuộc pha sóng lúc đặt tay, nhịp tim, mức tưới máu, chuyển động và cách che cảm biến; BPM thật không thể có trước khi quan sát đủ một chu kỳ mạch.
...
Em xác định nhóm trường PPG trong API gồm \Code{fingerPresent}, \Code{heartRateValid}, \Code{spo2Valid}, \Code{bpm}, \Code{spo2}, \Code{signalQuality}, \Code{redRaw} và \Code{irRaw}. Giao diện chỉ hiện BPM/SpO$_2$ khi cờ tương ứng hợp lệ; khi chưa đặt tay, thẻ số đo dùng ký hiệu chờ thay vì giữ số của phiên trước. Thanh chất lượng được giới hạn 0--100\% và dữ liệu thô được dùng để hỗ trợ chẩn đoán tín hiệu, không được trình bày như chỉ số sức khỏe.
...
Thời gian xuất kết quả tổng hợp & BPM 75 BPM không quá 1,75 giây; SpO$_2$ được xét từ khoảng 0,76 giây và không chờ BPM & \OK\\
