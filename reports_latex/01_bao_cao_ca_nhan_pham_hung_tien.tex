...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=0.92\linewidth,height=4.7cm,keepaspectratio]{assets/grayscale/esp32s3_freenove.jpg}
    \\[2pt]\small (a) Bo Freenove ESP32-S3-WROOM N16R8.
  \end{minipage}\hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=0.92\linewidth,height=4.7cm,keepaspectratio,trim=110 30 110 30,clip]{assets/grayscale/oled_ssd1306.jpg}
