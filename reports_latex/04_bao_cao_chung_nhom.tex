...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=0.88\linewidth,height=4.5cm,keepaspectratio]{assets/grayscale/esp32s3_freenove.jpg}
    \\[2pt]\small (a) Bo điều khiển Freenove ESP32-S3 N16R8.
  \end{minipage}\hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=0.88\linewidth,height=4.5cm,keepaspectratio,trim=110 30 110 30,clip]{assets/grayscale/oled_ssd1306.jpg}
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=0.90\linewidth,height=4.0cm,keepaspectratio]{assets/grayscale/max30102_board_overview.jpg}
    \\[2pt]\small (c) Bo breakout MAX30102 tham chiếu.
  \end{minipage}\hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=0.66\linewidth,height=4.0cm,keepaspectratio,trim=180 55 180 55,clip]{assets/grayscale/gps_neo6m_reference.jpg}
...
\node[process,below=of start] (read) {Đọc hết byte GPS đang chờ\\Rút và xử lý FIFO PPG};
