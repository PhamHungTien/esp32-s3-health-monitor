...
\midrule
Sơ đồ tích hợp, chân và cấu hình bo & 3 giờ & Bảng chân, cấu hình N16R8\\
Hàm I2C và quét thiết bị & 4 giờ & Đọc/ghi thanh ghi, phát hiện 0x3C/0x57/0x68\\
Driver SSD1306 và giao diện OLED & 6 giờ & Framebuffer, màn hình sức khỏe/cảnh báo\\
Wi-Fi AP, captive portal, API và dashboard & 7 giờ & Web responsive, JSON và hai thao tác POST\\
Lịch chạy, phục hồi và tích hợp & 5 giờ & Vòng lặp không chặn\\
Biên dịch, nạp và kiểm thử tổng & 5 giờ & Firmware và hai giao diện hoạt động\\
\midrule
...
Phần tích hợp kết hợp OLED và cổng web cục bộ; ba thiết bị I2C, GPS, buzzer cùng dịch vụ HTTP/DNS tự viết được tổ chức trong cùng vòng lặp. Hệ thống hiện mới được thử nghiệm bằng nguồn USB; cần đo tải Wi-Fi, thời gian hoạt động bằng pin, bổ sung xác thực thao tác và hoàn thiện vỏ đeo.
